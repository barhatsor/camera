...
document.querySelector('#gallery-input').addEventListener('change', function() {
  ...
  if (files) {
    ...
    files.forEach(async (file) => {
      ...
      galleryWrapper.innerHTML += '<video src="' + URL.createObjectURL(file) + '" style="background-image:url(\'' + thumbnailURL + '\')" onclick="if (!this.dontOpen) { this.play(); } else { this.setAttribute(\'dontOpen\', false); }" onpause="this.setAttribute(\'dontOpen\', true);this.click()" class="picture" crossorigin="anonymous"></video>';
