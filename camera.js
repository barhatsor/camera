...
document.querySelector('#gallery-input').addEventListener('change', function() {
  ...
  if (files) {
    ...
    files.forEach(async (file) => {
      ...
      galleryWrapper.innerHTML += '<video src="' + URL.createObjectURL(file) + '" style="background-image:url(\'' + thumbnailURL + '\')" onclick="if (!this.dontOpen) { this.play(); } else { this.dontOpen = false; }" onpause="this.dontOpen = true;this.click()" class="picture" crossorigin="anonymous"></video>';
