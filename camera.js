...
document.querySelector('#gallery-input').addEventListener('change', function() {
  ...
  if (files) {
    ...
    files.forEach(async (file) => {
      ...
      galleryWrapper.innerHTML += '<video src="' + URL.createObjectURL(file) + '" style="background-image:url(\'' + thumbnailURL + '\')" onclick="this.play()" onpause="this.addAttribute(\'controls\');this.removeAttribute(\'controls\');" class="picture" crossorigin="anonymous"></video>';
