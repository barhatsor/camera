...
document.querySelector('#gallery-input').addEventListener('change', function() {
  ...
  if (files) {
    ...
    files.forEach(async (file) => {
      ...
      galleryWrapper.innerHTML += '<video src="' + URL.createObjectURL(file) + '" style="background-image:url(\'' + thumbnailURL + '\')" ontouchdown="this.play()" onpause="this.click()" class="picture" crossorigin="anonymous"></video>';
